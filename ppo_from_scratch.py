...
def init_args():
    parser = argparse.ArgumentParser(description="PPO from scratch")
...
if __name__ == "__main__":
    args = init_args()
    if args.debug:
        print("Debug mode is enabled. This will use a smaller model and fewer episodes for quick testing.")
    ...
    # 奖励模型
    reward_model = AutoModelForSequenceClassification.from_pretrained('OpenAssistant/reward-model-deberta-v3-large-v2').to(device)
